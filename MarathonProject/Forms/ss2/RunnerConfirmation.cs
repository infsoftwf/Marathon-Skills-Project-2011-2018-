...
{
    public partial class RunnerConfirmation : Form
    {
        Thread mainThread = null;

        public RunnerConfirmation()
        {
            InitializeComponent();
        }

        private void RunnerConfirmation_Load(object sender, EventArgs e)
        {
        ...
        private void backbut_Click(object sender, EventArgs e)
        {
            ...
            Application.OpenForms.OfType<MarathonRegister>().Single().Show();

            this.Dispose();
            this.Close();
        }

        private void RunnerConfirmation_FormClosed(object sender, FormClosedEventArgs e)
        {
            if (mainThread != null)
                mainThread.Abort();
