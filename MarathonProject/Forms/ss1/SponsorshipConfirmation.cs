...
namespace MarathonProject.Forms
{
    public partial class SponsorshipConfirmation : Form
    {
        ...
        public SponsorshipConfirmation(String str1, String str2)
        {
            InitializeComponent();
        ...
        private void backbut_Click(object sender, EventArgs e)
        {
            ...
            Application.OpenForms.OfType<SponsorRunner>().Single().Show();

            this.Dispose();
            this.Close();
        }

        private void SponsorshipConfirmation_FormClosed(object sender, FormClosedEventArgs e)
        {
            if (mainThread != null)
                mainThread.Abort();
