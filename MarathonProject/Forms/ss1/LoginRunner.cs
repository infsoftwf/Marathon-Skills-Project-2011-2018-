...
{
    public partial class LoginRunner : Form
    {
        ...
        private void LoginRunner_Load(object sender, EventArgs e)
        {           
        ...
        private void LoginRunner_FormClosed(object sender, FormClosedEventArgs e)
        {
            if (mainThread != null)
                mainThread.Abort();
        ...
        private void butPreLog_Click(object sender, EventArgs e)
        {
            new Login(false, true).Show();
            this.Hide();
        }
